...
[
  ...
  'REQUEST_KUBERNETES_SERVICE_CREATE_ERROR',
  'REQUEST_KUBERNETES_SERVICE_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_SERVICE_DELETE_ERROR',
  'REQUEST_KUBERNETES_SERVICE_DELETE_SUCCESS',
  'REQUEST_KUBERNETES_SERVICE_FETCH_ERROR',
  'REQUEST_KUBERNETES_SERVICE_FETCH_ONGOING',
  'REQUEST_KUBERNETES_SERVICE_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_SERVICES_FETCH_ERROR',
  'REQUEST_KUBERNETES_SERVICES_FETCH_ONGOING',
  'REQUEST_KUBERNETES_SERVICES_FETCH_SUCCESS',

  'REQUEST_KUBERNETES_RC_CREATE_ERROR',
  'REQUEST_KUBERNETES_RC_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_RC_DELETE_ERROR',
  'REQUEST_KUBERNETES_RC_DELETE_SUCCESS',
  'REQUEST_KUBERNETES_RC_FETCH_ERROR',
  'REQUEST_KUBERNETES_RC_FETCH_ONGOING',
  'REQUEST_KUBERNETES_RC_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_RCS_FETCH_ERROR',
  'REQUEST_KUBERNETES_RCS_FETCH_ONGOING',
  'REQUEST_KUBERNETES_RCS_FETCH_SUCCESS',

  'REQUEST_KUBERNETES_POD_CREATE_ERROR',
  'REQUEST_KUBERNETES_POD_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_POD_DELETE_ERROR',
  'REQUEST_KUBERNETES_POD_DELETE_SUCCESS',
  'REQUEST_KUBERNETES_POD_FETCH_ERROR',
  'REQUEST_KUBERNETES_POD_FETCH_ONGOING',
  'REQUEST_KUBERNETES_POD_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_PODS_FETCH_ERROR',
  'REQUEST_KUBERNETES_PODS_FETCH_ONGOING',
  'REQUEST_KUBERNETES_PODS_FETCH_SUCCESS',

  'REQUEST_KUBERNETES_PV_CREATE_ERROR',
  'REQUEST_KUBERNETES_PV_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_PV_DELETE_ERROR',
  'REQUEST_KUBERNETES_PV_DELETE_SUCCESS',
  'REQUEST_KUBERNETES_PV_FETCH_ERROR',
  'REQUEST_KUBERNETES_PV_FETCH_ONGOING',
  'REQUEST_KUBERNETES_PV_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_PVS_FETCH_ERROR',
  'REQUEST_KUBERNETES_PVS_FETCH_ONGOING',
  'REQUEST_KUBERNETES_PVS_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_PVC_CREATE_ERROR',
  'REQUEST_KUBERNETES_PVC_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_PVC_FETCH_ERROR',
  'REQUEST_KUBERNETES_PVC_FETCH_ONGOING',
  'REQUEST_KUBERNETES_PVC_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_PVCS_FETCH_ERROR',
  'REQUEST_KUBERNETES_PVCS_FETCH_ONGOING',
  'REQUEST_KUBERNETES_PVCS_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_POLICY_CREATE_ERROR',
  'REQUEST_KUBERNETES_POLICY_CREATE_SUCCESS',
  'REQUEST_KUBERNETES_POLICY_FETCH_ERROR',
  'REQUEST_KUBERNETES_POLICY_FETCH_ONGOING',
  'REQUEST_KUBERNETES_POLICY_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_POLICIES_FETCH_ERROR',
  'REQUEST_KUBERNETES_POLICIES_FETCH_ONGOING',
  'REQUEST_KUBERNETES_POLICIES_FETCH_SUCCESS',
  'REQUEST_KUBERNETES_POLICY_DELETE_ERROR',
  'REQUEST_KUBERNETES_POLICY_DELETE_SUCCESS',
