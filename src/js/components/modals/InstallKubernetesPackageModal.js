...
class InstallKubernetesPackageModal extends mixin(InternalStorageMixin, TabsMixin, StoreMixin) {
  ...
  handleInstallKubernetesPackage() {
    ...
    CosmosPackagesStore.installKubernetesPackage(name, version, configuration);
          ...
          <div className="container">
            <div className="button-collection horizontal-center flush-bottom">
              <button
                ...
                onClick={this.handleInstallKubernetesPackage}>
                {buttonText}
              </button>
              <button
                disabled={!cosmosPackage || pendingRequest}
...
InstallKubernetesPackageModal.defaultProps = {
  onClose: function () {},
  open: false
};

InstallKubernetesPackageModal.propTypes = {
...
module.exports = InstallKubernetesPackageModal;
